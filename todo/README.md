...
| [002](./002-alpha-compact-prune-memory.md) | compaction / pruner / memory.json | 🔄 in progress | P0 |
...
| [006](./006-alpha-readiness-score.md) | `doctor --readiness` для alpha | ⏳ pending | P2 |
| [007](./007-alpha-network-allowlist.md) | Guest egress proxy / allowlist | ⏳ pending | P2 |
| [008](./008-alpha-multistack.md) | `--name` stacks + status | ⏳ pending | P2 |
